...
non_vowels = re.sub(r"[aeiou]", "", teststring)
print(non_vowels)
...
capital_letters = [match.span() for match in re.finditer(r"[A-Z]", teststring)]
...
consonants = [match.span() for match in re.finditer(r"[B-DF-HJ-NP-TV-Z[b-df-hj-np-tv-z]", teststring)]
print(consonants)
...
random_lists = [[random.choice(list(range(101))) for n in range(10)] for l in range(4)]
print(random_lists)
...
flatten_list = [n for lista in list_of_lists for n in lista]
print(flatten_list)
